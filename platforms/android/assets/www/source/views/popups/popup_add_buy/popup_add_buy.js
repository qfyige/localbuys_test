RAD.view("view.popup_add_buy", RAD.Blanks.ScrollableView.extend({
...
//        'tap .lodging': 'lodgingValue'
    ...
    shopValue: function (e) {
        this.model.set({ category_id: e.currentTarget.attributes[1].value, category_name: e.currentTarget.attributes[2].value });
        var options = {
